...
@pytest.mark.parametrize('input, expected', [
 ...
 (
    ...
    ([[5, 6, 10, 15, 16, 17, 21, 22, 24, 27, 33, 34, 35], [0, 2, 23, 28]], 17)
 ),
 (
    ...
    ([[2, 3, 4, 49, 52, 54, 55, 75, 14, 76, 22, 41, 43], [25, 77, 59, 71, 78, 19, 21, 40, 12, 24], [34, 65, 69, 38, 6, 30, 17], [67, 47, 58, 10, 62], [64, 26, 60, 11], [46, 8, 39, 51], [48, 16, 53], [32, 1, 42], [36, 7], [5, 29], [9, 83], [45, 81], [61, 23], [72]], 60)
 ),
 (
    ...
    ([[3, 4, 5, 55, 59, 60, 61, 82, 18, 85, 26, 48, 50], [29, 86, 65, 78, 87, 22, 23, 47, 16, 28], [40, 72, 75, 44, 7, 35, 20], [73, 54, 64, 10, 68], [11, 79, 36, 58, 15], [71, 17, 33, 67], [52, 9, 45, 57], [88, 56, 69], [74, 83, 43], [19, 77, 27], [38, 1, 49], [66, 14]], 62)
 ),
])
